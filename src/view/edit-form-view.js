...
function createNewEditFormTemplate(point) {
  const {type,name,dateFrom,dateTo,basePrice,title,price,description, src} = point;
...
export default class NewEditFormView {
  ...
  getTemplate() {
    return createNewEditFormTemplate(this.point);
  }
